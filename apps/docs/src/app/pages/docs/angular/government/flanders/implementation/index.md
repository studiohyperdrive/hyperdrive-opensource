...
Using the `NgxAcmComponentInjectionService` we can inject an ACM Global Header or Global Footer in our Angular applications. We can use this by using the `injectGlobalHeaderComponent` or the `injectGlobalFooterComponent`
