...
export class NgxHasPermissionDirective<PermissionType extends string> implements OnDestroy {
	 ...
	 */
	@Input() public set hasPermission(permission: PermissionType | PermissionType[]) {
	 ...
	 */
	@Input() public set hasPermissionElse(ngTemplate: TemplateRef<any>) {
	 ...
	 */
	@Input() public set hasPermissionShouldHavePermission(shouldHavePermissionEnabled: boolean) {
	 ...
	 */
	@Input() public set hasPermissionShouldHaveAllPermissions(shouldHaveAllPermissions: boolean) {
	...
	private updateView(): void {
		...
		this.authenticationService
			.hasPermission(
				Array.isArray(this.permission) ? this.permission : [this.permission],
